...
def build_server() -> MCPServer:
    mcp = MCPServer(
        ...
        instructions=(
            ...
            "- 工程预检 (kicad_sch_ensure_project)：为原理图自动补齐同名 .kicad_pro、\n"
            "sym-lib-table 和 fp-lib-table，并在绘图前校验 ${KIPRJMOD} 本地库路径。\n"
            "- 重载门禁 (kicad_sch_reload_gate)：自动保存、关闭、使用仓库 Eeschema\n"
            "重开两轮；检查加载修复、未保存修改和层级工程语义快照稳定性。\n"
